...
const baseAttributes: Record<AttributesViewType, AttributeType[]> = {
  weekly: [
...
const DECAY_PER_STEP: Record<Exclude<AttributesViewType, "overall">, number> = {
  weekly: 5,
  monthly: 8,
  yearly: 12,
}

const VARIANCE_PER_INDEX: Record<Exclude<AttributesViewType, "overall">, number> = {
  weekly: 3,
  monthly: 5,
  yearly: 7,
}

function applyOffset(view: AttributesViewType, offset: number): AttributeType[] {
